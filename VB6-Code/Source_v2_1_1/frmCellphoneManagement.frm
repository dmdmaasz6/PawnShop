...
Begin VB.Form frmCellphoneManagement 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Standard Stock Mangement"
   ClientHeight    =   7620
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   8130
   ...
   EndProperty
   Icon            =   "frmCellphoneManagement.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   7620
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Label Label1 
         BackColor       =   &H00E0E0E0&
         BackStyle       =   0  'Transparent
         Caption         =   $"frmCellphoneManagement.frx":08CA
         Height          =   615
         Left            =   240
         TabIndex        =   6
         Top             =   360
   ...
   Begin MSDataGridLib.DataGrid dgCellphone 
      Bindings        =   "frmCellphoneManagement.frx":095B
      Height          =   2415
      Left            =   120
      TabIndex        =   0
      Top             =   240
   ...
   End
End
Attribute VB_Name = "frmCellphoneManagement"
...
Private Sub Form_Load()
    ...
    frmCellphoneManagement.adodcCellphone.ConnectionString = gstrConnect
    frmCellphoneManagement.adodcCellphone.RecordSource = "SELECT NSID, Description, RecommendedSellingPrice, (Quantity - QuantitySold - QuantityLayBuy) as QuantityAvailable, Quantity, QuantitySold, QuantityLayBuy, CellphoneAssessories FROM NormalStock WHERE (CellphoneAssessories = 1) order by Description"
    frmCellphoneManagement.adodcCellphone.Refresh
End Sub
